...
const addEmployee = () => {
    ...
    return `INSERT INTO employees (first_name, last_name, deptrole_id, manager_id) VALUES (${first_name}, ${last_name}, ${deptrole_id}, ${manager_id})`
}
...
const viewDepartments = () => {
    return `SELECT id AS ID, department_name AS Department
    FROM departments`;
}
